...
public class ConsoleServicosView extends javax.swing.JFrame implements View {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsoleServicosView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsoleServicosView().setVisible(true);
            }
        });
    }
